...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calc = function calc(size, materials, options, promocode, result) {
  var sizeBlock = document.querySelector(size),
      materialBlock = document.querySelector(materials),
...
var filter = function filter() {
  ...
  btnAll.addEventListener('click', typeFilter.bind(null, markAll));
  btnLovers.addEventListener('click', typeFilter.bind(null, markLovers));
  btnChef.addEventListener('click', typeFilter.bind(null, markChef));
  btnGirl.addEventListener('click', typeFilter.bind(null, markGirl));
  btnGuy.addEventListener('click', typeFilter.bind(null, markGuy));
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      var scrollHeigh = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight);

      if (!btnPressed && window.pageYOffset + document.documentElement.clientHeight >= scrollHeigh) {
